...
/************************************************************
*
*       Filename        :       VInstructions.scala
*       Author          :       liangzh
*       Revision        :       2019/04/09
*       Company         :       UC TECH IP
*       Department      :       MAG
*       Description     :       RISC-V vector encode pattern
*
************************************************************/
package vpu
...
object VInstructions {
  ...
  def VADC_VVM       = BitPat("b010000???????????000?????1010111")
  def VADC_VXM       = BitPat("b010000???????????100?????1010111")
  def VADC_VIM       = BitPat("b010000???????????011?????1010111")
  ...
  def VSBC_VVM       = BitPat("b010010???????????000?????1010111")
  def VSBC_VXM       = BitPat("b010010???????????100?????1010111")
  ...
  def VMERGE_VVM     = BitPat("b010111???????????000?????1010111")
  def VMERGE_VXM     = BitPat("b010111???????????100?????1010111")
  def VMERGE_VIM     = BitPat("b010111???????????011?????1010111")
  //CSR instructions
  def VSETVLI        = BitPat("b0????????????????111?????1010111")
  def VSETVL         = BitPat("b1000000??????????111?????1010111")
  //load instructions
  def VLB_V          = BitPat("b???100???????????000?????0000111")
  def VLH_V          = BitPat("b???100???????????101?????0000111")
  def VLW_V          = BitPat("b???100???????????110?????0000111")
  def VLBU_V         = BitPat("b???000???????????000?????0000111")
  def VLHU_V         = BitPat("b???000???????????101?????0000111")
  def VLWU_V         = BitPat("b???000???????????110?????0000111")
  def VLE_V          = BitPat("b???000???????????111?????0000111")
  ...
  //store instructions
  def VSB_V          = BitPat("b???000???????????000?????0100111")
  def VSH_V          = BitPat("b???000???????????101?????0100111")
  def VSW_V          = BitPat("b???000???????????110?????0100111")
  def VSE_V          = BitPat("b???000???????????111?????0100111")
  ...
  def VID_V          = BitPat("b010100??????10001010?????1010111")
  ...
  //integer quad-widening muladd instructions
  ...
  def VMV_X_S        = BitPat("b010000??????00000010?????1010111")
  def VMV_S_X        = BitPat("b010000?00000?????110?????1010111")
  //fixed-point saturating add and subtract instructions
  ...
  //fixed-point averaging add and subtract instructions
  ...
  //floating-point muldiv instructions
  ...
  //floating-point muladd instructions
  ...
  //floating-point sign-injection instructions
  ...
  //floating-point merge instruction
  def VFMERGE_VFM    = BitPat("b010111???????????101?????1010111")
  //floating-point scalar move instructions
  def VFMV_F_S       = BitPat("b010000??????00000001?????1010111")
  def VFMV_S_F       = BitPat("b010000?00000?????101?????1010111")
  ...
  def VFNCVT_ROD_FFW = BitPat("b100010??????10101001?????1010111")
  ...
  //floating -point dot-product instruction
  def VFDOT_VV       = BitPat("b111001???????????001?????1010111")
  //AMO instructions
  def VAMOYW_V       = BitPat("b?????1???????????110?????0101111")
  def VAMOYE_V       = BitPat("b?????1???????????111?????0101111")
  def VAMONW_V       = BitPat("b?????0???????????110?????0101111")
  def VAMONE_V       = BitPat("b?????0???????????111?????0101111")
}
