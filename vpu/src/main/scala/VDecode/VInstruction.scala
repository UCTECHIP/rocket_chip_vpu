...
*       Revision        :       2020/10/28
*       Company         :       UC TECH IP
*       Description     :       RISC-V base vector extension 1.0-ver insts encode pattern
*
************************************************************/
package vpu
...
object VInstructions {
  ...
  //                             |  || ||    |    |  vd
  //                             |  || ||    |    |  |
  def VLE_V           = BitPat("b????00?00000?????????????0000111")
  def VLEFF_V         = BitPat("b????00?10000?????????????0000111")
  def VLR_V           = BitPat("b????00101000?????????????0000111")
  def VLSE_V          = BitPat("b????10???????????????????0000111")
  def VLXEI_V         = BitPat("b???011???????????????????0000111")
  //store instructions
  //                             nf mew
  //                             |  |mop
  //                             |  || vm
  ...
  //                             |  || ||    |    |  vs3
  //                             |  || ||    |    |  |
  def VSE_V           = BitPat("b????00?00000?????????????0100111")
  def VSR_V           = BitPat("b????00101000?????????????0100111")
  def VSSE_V          = BitPat("b????10???????????????????0100111")
  def VSXEI_V         = BitPat("b???0?1???????????????????0100111")
  //AMO instructions
  //                             amoop       rs1  width
  //                             |    wd     |    |  vs3/vd
  //                             |    |vm    |    |  |
  //                             |    ||vs2  |    |  |
  //                             |    |||    |    |  |
  def VAMOYEI_V       = BitPat("b?????1???????????????????0101111")
  def VAMONEI_V       = BitPat("b?????0???????????????????0101111")
  ...
  def VFCVT_V         = BitPat("b010010??????00???001?????1010111")
  def VFWCVT_V        = BitPat("b010010??????01???001?????1010111")
  def VFNCVT_V        = BitPat("b010010??????10???001?????1010111")
  ...
  //floating-point reciprocal square root instruction
  def VFRSQRTE7_V     = BitPat("b010011??????00100001?????1010111")
  //floating-point reciprocal instruction
  def VFRECE7_V       = BitPat("b010011??????00101001?????1010111")
